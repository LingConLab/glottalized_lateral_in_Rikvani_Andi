...
author: "M. Daniel, G. Moroz, A. Shiryayev"
output: 
  html_document:
      df_print: paged
      code_folding: hide
...
read_csv("data/modified_data.csv") %>% 
  mutate(conditionNorm2 = factor(conditionNorm2, levels = c("lˀ, Individual words", "l, Individual words", "lˀ, Carrier phrase", "l, Carrier phrase", "lˀ, Free narrative", "l, Free narrative"))) ->
  dataWrd
```
